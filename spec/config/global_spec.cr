...
module Litin::Config
  private def self.parse_global_string(content : String) : GlobalConfig
  ...
  describe GlobalConfig do
    ...
    it "ignores unknown keys" do
      cfg = parse_global_string(%(totally_unknown_key="whatever"\n))
      cfg.services_dir.should eq("/etc/litin/services")
    end

    it "reads single-quoted values" do
      cfg = parse_global_string(%(socket_path='/run/myinit/litind.sock'\n))
